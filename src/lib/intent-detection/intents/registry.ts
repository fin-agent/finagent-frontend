...
export const intentRegistry: IntentDefinition[] = [
  ...
  // === ACCOUNT DOMAIN ===
  {
    ...
    description: 'User asks about account balance, equity, buying power, margin, cash withdrawal, available funds, debit/credit balances, or general account info',
    examples: [
      ...
      'Credit balances this month',
      'Show my debit balance trend',
      'What is the market value of my positions?',
